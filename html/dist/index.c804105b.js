...
})({"bEpU8":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "a2a5ae10c804105b";
"use strict";
...
},{}],"crVZ2":[function(require,module,exports) {
const { context, trace } = require("bcfefa5b44fbebfe");
const { ConsoleSpanExporter, SimpleSpanProcessor } = require("bf9940b5f3c1e19");
const { OTLPTraceExporter } = require("8837b9bbd6460085");
const { WebTracerProvider } = require("d8ed7281fca918af");
const { FetchInstrumentation } = require("963a77f6daf00907");
const { ZoneContextManager } = require("cca159fec9c39a4b");
const { B3Propagator } = require("49e2e986d25a7fdc");
const { registerInstrumentations } = require("5b384214f9c6a2a");
const { Resource } = require("fdd333f9f50b37e0");
const { SEMRESATTRS_SERVICE_NAME } = require("61d148898f4dfb84");
...
},{"bcfefa5b44fbebfe":"6AC4z","bf9940b5f3c1e19":"jj5uM","8837b9bbd6460085":"9CGFP","d8ed7281fca918af":"eXZZL","963a77f6daf00907":"iWezV","cca159fec9c39a4b":"cmUfS","49e2e986d25a7fdc":"4gph1","5b384214f9c6a2a":"3OTpd","fdd333f9f50b37e0":"loqSh","61d148898f4dfb84":"lCgfj"}],"6AC4z":[function(require,module,exports) {
/*
...
},{}],"4gph1":[function(require,module,exports) {
/*
 * Copyright The OpenTelemetry Authors
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _b3Propagator = require("./B3Propagator");
parcelHelpers.exportAll(_b3Propagator, exports);
var _constants = require("./constants");
parcelHelpers.exportAll(_constants, exports);
var _types = require("./types");
parcelHelpers.exportAll(_types, exports);

},{"./B3Propagator":"dtVTC","./constants":false,"./types":false,"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dtVTC":[function(require,module,exports) {
/*
 * Copyright The OpenTelemetry Authors
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "B3Propagator", ()=>B3Propagator);
var _core = require("@opentelemetry/core");
var _b3MultiPropagator = require("./B3MultiPropagator");
var _b3SinglePropagator = require("./B3SinglePropagator");
var _constants = require("./constants");
var _types = require("./types");
/**
 ...
 */ var B3Propagator = /** @class */ function() {
    function B3Propagator(config) {
        if (config === void 0) config = {};
        this._b3MultiPropagator = new (0, _b3MultiPropagator.B3MultiPropagator)();
        this._b3SinglePropagator = new (0, _b3SinglePropagator.B3SinglePropagator)();
        if (config.injectEncoding === (0, _types.B3InjectEncoding).MULTI_HEADER) {
    ...
    B3Propagator.prototype.inject = function(context, carrier, setter) {
        if ((0, _core.isTracingSuppressed)(context)) return;
        this._inject(context, carrier, setter);
    };
    B3Propagator.prototype.extract = function(context, carrier, getter) {
        var header = getter.get(carrier, (0, _constants.B3_CONTEXT_HEADER));
        var b3Context = Array.isArray(header) ? header[0] : header;
        if (b3Context) return this._b3SinglePropagator.extract(context, carrier, getter);
...
},{"@opentelemetry/core":"dBsXh","./B3MultiPropagator":"66bFb","./B3SinglePropagator":"1pnAH","./constants":"fRdE9","./types":"ek7U7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"66bFb":[function(require,module,exports) {
/*
 * Copyright The OpenTelemetry Authors
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "B3MultiPropagator", ()=>B3MultiPropagator);
var _api = require("@opentelemetry/api");
var _core = require("@opentelemetry/core");
var _common = require("./common");
var _constants = require("./constants");
...
function isValidSampledValue(sampled) {
    return sampled === (0, _api.TraceFlags).SAMPLED || sampled === (0, _api.TraceFlags).NONE;
}
...
function getTraceId(carrier, getter) {
    var traceId = getHeaderValue(carrier, getter, (0, _constants.X_B3_TRACE_ID));
    if (typeof traceId === "string") return traceId.padStart(32, "0");
    return "";
}
function getSpanId(carrier, getter) {
    var spanId = getHeaderValue(carrier, getter, (0, _constants.X_B3_SPAN_ID));
    if (typeof spanId === "string") return spanId;
    return "";
}
function getDebug(carrier, getter) {
    var debug = getHeaderValue(carrier, getter, (0, _constants.X_B3_FLAGS));
    return debug === "1" ? "1" : undefined;
}
function getTraceFlags(carrier, getter) {
    var traceFlags = getHeaderValue(carrier, getter, (0, _constants.X_B3_SAMPLED));
    var debug = getDebug(carrier, getter);
    if (debug === "1" || VALID_SAMPLED_VALUES.has(traceFlags)) return (0, _api.TraceFlags).SAMPLED;
    if (traceFlags === undefined || VALID_UNSAMPLED_VALUES.has(traceFlags)) return (0, _api.TraceFlags).NONE;
 ...
 */ var B3MultiPropagator = /** @class */ function() {
    ...
    B3MultiPropagator.prototype.inject = function(context, carrier, setter) {
        var spanContext = (0, _api.trace).getSpanContext(context);
        if (!spanContext || !(0, _api.isSpanContextValid)(spanContext) || (0, _core.isTracingSuppressed)(context)) return;
        var debug = context.getValue((0, _common.B3_DEBUG_FLAG_KEY));
        setter.set(carrier, (0, _constants.X_B3_TRACE_ID), spanContext.traceId);
        setter.set(carrier, (0, _constants.X_B3_SPAN_ID), spanContext.spanId);
        // According to the B3 spec, if the debug flag is set,
        // the sampled flag shouldn't be propagated as well.
        if (debug === "1") setter.set(carrier, (0, _constants.X_B3_FLAGS), debug);
        else if (spanContext.traceFlags !== undefined) // We set the header only if there is an existing sampling decision.
        // Otherwise we will omit it => Absent.
        setter.set(carrier, (0, _constants.X_B3_SAMPLED), ((0, _api.TraceFlags).SAMPLED & spanContext.traceFlags) === (0, _api.TraceFlags).SAMPLED ? "1" : "0");
    };
    B3MultiPropagator.prototype.extract = function(context, carrier, getter) {
        ...
        var debug = getDebug(carrier, getter);
        if ((0, _api.isValidTraceId)(traceId) && (0, _api.isValidSpanId)(spanId) && isValidSampledValue(traceFlags)) {
            context = context.setValue((0, _common.B3_DEBUG_FLAG_KEY), debug);
            return (0, _api.trace).setSpanContext(context, {
                traceId: traceId,
                spanId: spanId,
                isRemote: true,
                traceFlags: traceFlags
    ...
    B3MultiPropagator.prototype.fields = function() {
        return [
            (0, _constants.X_B3_TRACE_ID),
            (0, _constants.X_B3_SPAN_ID),
            (0, _constants.X_B3_FLAGS),
            (0, _constants.X_B3_SAMPLED),
            (0, _constants.X_B3_PARENT_SPAN_ID)
        ];
    };
    return B3MultiPropagator;
}();

},{"@opentelemetry/api":"6AC4z","@opentelemetry/core":"dBsXh","./common":"jkwpK","./constants":"fRdE9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jkwpK":[function(require,module,exports) {
/*
 * Copyright The OpenTelemetry Authors
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "B3_DEBUG_FLAG_KEY", ()=>B3_DEBUG_FLAG_KEY);
var _api = require("@opentelemetry/api");
var B3_DEBUG_FLAG_KEY = (0, _api.createContextKey)("OpenTelemetry Context Key B3 Debug Flag");

},{"@opentelemetry/api":"6AC4z","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fRdE9":[function(require,module,exports) {
/*
 * Copyright The OpenTelemetry Authors
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ /** B3 single-header key */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "B3_CONTEXT_HEADER", ()=>B3_CONTEXT_HEADER);
parcelHelpers.export(exports, "X_B3_TRACE_ID", ()=>X_B3_TRACE_ID);
parcelHelpers.export(exports, "X_B3_SPAN_ID", ()=>X_B3_SPAN_ID);
parcelHelpers.export(exports, "X_B3_SAMPLED", ()=>X_B3_SAMPLED);
parcelHelpers.export(exports, "X_B3_PARENT_SPAN_ID", ()=>X_B3_PARENT_SPAN_ID);
parcelHelpers.export(exports, "X_B3_FLAGS", ()=>X_B3_FLAGS);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1pnAH":[function(require,module,exports) {
/*
 * Copyright The OpenTelemetry Authors
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "B3SinglePropagator", ()=>B3SinglePropagator);
var _api = require("@opentelemetry/api");
var _core = require("@opentelemetry/core");
var _common = require("./common");
var _constants = require("./constants");
...
function convertToTraceFlags(samplingState) {
    if (samplingState && SAMPLED_VALUES.has(samplingState)) return (0, _api.TraceFlags).SAMPLED;
    return (0, _api.TraceFlags).NONE;
}
/**
 ...
 */ var B3SinglePropagator = /** @class */ function() {
    ...
    B3SinglePropagator.prototype.inject = function(context, carrier, setter) {
        var spanContext = (0, _api.trace).getSpanContext(context);
        if (!spanContext || !(0, _api.isSpanContextValid)(spanContext) || (0, _core.isTracingSuppressed)(context)) return;
        var samplingState = context.getValue((0, _common.B3_DEBUG_FLAG_KEY)) || spanContext.traceFlags & 0x1;
        var value = spanContext.traceId + "-" + spanContext.spanId + "-" + samplingState;
        setter.set(carrier, (0, _constants.B3_CONTEXT_HEADER), value);
    };
    B3SinglePropagator.prototype.extract = function(context, carrier, getter) {
        ...
        if (!(0, _api.isValidTraceId)(traceId) || !(0, _api.isValidSpanId)(spanId)) return context;
        var traceFlags = convertToTraceFlags(samplingState);
        if (samplingState === DEBUG_STATE) context = context.setValue((0, _common.B3_DEBUG_FLAG_KEY), samplingState);
        return (0, _api.trace).setSpanContext(context, {
            traceId: traceId,
            spanId: spanId,
            isRemote: true,
    ...
    B3SinglePropagator.prototype.fields = function() {
        return [
            (0, _constants.B3_CONTEXT_HEADER)
        ];
    };
    return B3SinglePropagator;
}();

},{"@opentelemetry/api":"6AC4z","@opentelemetry/core":"dBsXh","./common":"jkwpK","./constants":"fRdE9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ek7U7":[function(require,module,exports) {
/*
 * Copyright The OpenTelemetry Authors
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ /** Enumeration of B3 inject encodings */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "B3InjectEncoding", ()=>B3InjectEncoding);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["bEpU8","crVZ2"], "crVZ2", "parcelRequiree764")

//# sourceMappingURL=index.c804105b.js.map
